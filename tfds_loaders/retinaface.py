...
_RETINAFACE_ANNOT_URL = ('https://www.dropbox.com/s/7j70r3eeepe4r2g/retinaface_gt_v1.1.zip?dl=1')
...
class RetinaFace(tfds.core.GeneratorBasedBuilder):
    """WIDER Face dataset."""
    ...
    def _split_generators(self, dl_manager):
        ...
        extracted_dirs = dl_manager.download_and_extract({
            ...
            'retinaface_annot': _RETINAFACE_ANNOT_URL
        })
...
#                 })
    ...
    def _get_facial_landark_values(self):
        pass
    ...
    def _parse_retina_annotation_file(self, filename):
        with tf.io.gfile.GFile(filename, 'r') as f:
            meta = f.read()
        meta = meta.split('\n')
        #chunkify
